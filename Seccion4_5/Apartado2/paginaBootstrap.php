                    ...
                    <div class="row">
                        <form id="searchForm" class="form-inline mx-auto my-2 my-lg-0">
                            <div class="input-group">
                                ...
                                <input class="form-control mr-sm-2" id="destinationInput" type="search" placeholder="Where are you going?" aria-label="Destination" onkeyup="showHint(this.value)">
                            </div>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                </div>
                                <input class="form-control mr-sm-2" id="checkinDateInput" type="date" placeholder="Check-in Date">
                            </div>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                                </div>
                                <input class="form-control mr-sm-2" id="checkoutDateInput" type="date" placeholder="Check-out Date">
                            </div>
                            <div class="input-group">
                                <div class="input-group-prepend">
